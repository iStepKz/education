...
const services: Service[] = [
  {
    number: "01",
    title: "Обучение ИИ",
    subtitle: "Корпоративный курс · 6 часов",
    description:
    ...
    prices: [{ amount: "от 157 500 ₸", note: "за 1 сотрудника / курс 6 часов" }],
    footnote:
      "Формат и расписание согласуем. Для практики — материалы, разрешённые заказчиком. Цена со скидкой при группе от 7 человек.",
    icon: "AI",
