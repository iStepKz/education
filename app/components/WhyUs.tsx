    ...
    <section id="about" className="bg-slate-50/80 py-20 lg:py-28">
      <Container>
        <SectionHeader
          ...
          description="ТОО «iStep» — казахстанский центр обучения искусственному интеллекту, вайб-кодингу и цифровым навыкам для бизнеса. Проводим обучение для руководителей и сотрудников компаний в Астане и онлайн по Казахстану. Официальный сайт — istep.kz."
        />
